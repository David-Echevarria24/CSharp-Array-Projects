        ...
        do
        {
            ...
            switch (menuSelection)
            {
                ...
                case "2":
                    ...
                    {
                        Console.WriteLine("\nEnter dog characteristics to search for seperated by commmas.");
                        readResult = Console.ReadLine();
                        if (readResult != null)
                        {
                    ...
                    for (int i = 0; i < maxPets; i++)
                    {
                        if (ourAnimals[i, 1].Contains("dog"))
                        {
                            ...
                            foreach (string term in searchTerms)
                            {
                                ...
                                {
                                    Console.WriteLine($"Our dog {ourAnimals[i, 3].Substring(10)}");
                                    dogHasMatch = true;
                                    noMatchesDog = false;
                                }
                            }
                    ...
                    // prompt for the list of terms
                    // parse the list of terms
                    // search for the match on the list
